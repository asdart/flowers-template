...
const footerVideoSrc = encodeURI('/Glowing Tulip Serenity.mp4');

export default function Footer() {
  return (
    <footer className="relative w-full overflow-hidden border-t border-white/10 py-16 px-6 md:px-12 lg:px-[120px]">
      <video
        aria-hidden
        autoPlay
        loop
      ...
      <div className="pointer-events-none absolute inset-0 z-[1] bg-gradient-to-t from-black/85 via-black/55 to-black/40" />
      <div className="relative z-10 max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
      ...
      {/* Bottom Bar */}
      <div className="relative z-10 max-w-[1440px] mx-auto mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-white/72">
