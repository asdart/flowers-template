import imgFrame2147225845 from "figma:asset/31706ffb1ad06daf4781e92ab63fa9eb261cbd1e.png";
...
function Frame() {
  return (
    <div className="h-[438px] relative shrink-0 w-[329px]">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgFrame2147225845} />
    </div>
  );
}
...
function LeftColumn() {
  return (
    <div className="relative shrink-0 w-[591px]" data-name="Left column">
  ...
  return (
    <div className="flex-[1_0_0] min-w-px relative self-stretch">
      <div className="flex flex-row items-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[48px] items-center px-[24px] relative size-full">
          <Container2 />
          <Container3 />
        </div>
      </div>
  ...
  return (
    <div className="flex-[1_0_0] min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[96px] relative size-full">
        <div className="bg-white h-[185px] relative shrink-0 w-[591px]" data-name="Container">
          <div aria-hidden="true" className="absolute border-[#d4d4d4] border-solid border-t inset-0 pointer-events-none" />
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start pb-[48px] pt-[49px] relative size-full">
            <Frame1 />
          </div>
        </div>
        <div className="bg-white h-[185px] relative shrink-0 w-[591px]" data-name="Container">
...
export default function Services() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start px-[96px] py-[128px] relative size-full" data-name="Services">
      <Container />
    </div>
  );
}