  ...
  return (
    <div className="relative shrink-0 w-[1182px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[48px] items-start relative size-full">
        <p className="font-['DM_Sans',sans-serif] font-light italic leading-[20px] relative shrink-0 text-[#efdbbb] text-[14px] tracking-[-0.5px] whitespace-nowrap">Our Roots</p>
        <p className="font-['DM_Sans',sans-serif] font-normal leading-[0] relative shrink-0 text-[#525252] text-[48px] tracking-[-1.5px] w-[1182px]">
