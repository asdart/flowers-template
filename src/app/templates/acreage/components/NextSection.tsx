...
/* ═══════════════════════════════════════════════════════════════
   NextSection — feedback / testimonials carousel on white.
   Spring slide between quotes, avatar fades, big oversized quote
   typography. Section ID kept as #feedback to match deep links.
   ═══════════════════════════════════════════════════════════════ */
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Typewriter text="Customer Feedback" delay={0} speed={0.015} />
        </motion.h2>
            ...
            >
              ...
              <div>
                <h3 className="font-medium text-lg">
                  <Typewriter text={FEEDBACKS[currentIndex].author} delay={0.4} speed={0.015} />
                </h3>
                <p className="text-gray-500 text-sm">
                  <Typewriter text={FEEDBACKS[currentIndex].title} delay={0.5} speed={0.015} />
                </p>
              </div>
            </motion.div>
          </AnimatePresence>
